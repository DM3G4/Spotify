<script lang="ts">
	...
	export let song: { name: string; artist: string; duration: string };
</script>

<div class="fixed bottom-0 left-0 z-50 flex justify-around w-full h-24 px-4 bg-black">
	<div class="items-center justify-center hidden mr-auto text-gray-500 dark:text-gray-400 md:flex">
		<img
			class="h-12 mr-3 rounded"
			src="https://i.scdn.co/image/ab67616d00001e02e1f4c211ce1ef95454bbbcc4"
			alt="Video preview"
		/>
		<div class="flex flex-col pr-4">
			<span class="text-white">{song.name}</span>
			<span class="text-sm">{song.artist}</span>
		</div>
		...
		<div class="w-full">
			<div class="flex items-center justify-center mx-auto mb-1">
				...
				<button
					...
					type="button"
					class="inline-flex items-center justify-center p-2.5 mx-2 font-medium bg-green-600 rounded-full hover:bg-green-700 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-green-800"
				>
					<svg
			...
			<div class="flex items-center justify-between space-x-2">
				...
				<div class="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-800">
					<div class="bg-green-600 h-1.5 rounded-full" style="width: 65%" />
				</div>
